...
/* ============================================================
   [FETCH-METRICS] - Get Dashboard Metrics
   ============================================================ */
try {
...
/* ============================================================
   [FETCH-OPEN-JOBS] - Get Active Job Postings
   ============================================================ */
try {
    if (hasRole('recruiter')) {
...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-3">
        <div class="metric-card">
            ...
            <h3 class="metric-value"><?php echo $newApplications; ?></h3>
        ...
        <div class="section-card mb-4">
            ...
            <div class="section-body">
                ...
                <?php else: ?>
                    ...
                    <a href="jobs/view.php?id=<?php echo $job['job_id']; ?>" class="job-item" style="text-decoration: none;">
                        <div class="job-info">
                ...
                <?php else: ?>
                    ...
                    <a href="jobs/view.php?id=<?php echo $job['job_id']; ?>" class="job-item" style="text-decoration: none;">
                        <div style="display: flex; align-items: center; gap: 16px;">
                            ...
                            <div class="job-info">
                                <h6><?php echo htmlspecialchars($job['job_title']); ?></h6>
                                <div class="job-meta"><?php echo htmlspecialchars($job['company_name']); ?></div>
                            </div>
                        </div>
                        <div class="job-stats">
                            <div class="app-count"><?php echo $job['app_count']; ?></div>
